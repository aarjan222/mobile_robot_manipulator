...
def generate_launch_description():
    ...
    ompl_planning_yaml = load_yaml(
        "irb120_ros2_moveit2", "config/ompl_planning_egp64.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "irb120_ros2_moveit2", "config/irb120egp64_controllers.yaml")
    ...
    moveJ_interface = Node(
        ...
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {
            "use_sim_time": True}, {"ROB_PARAM": 'irb120_arm'}],
    )
    # MoveG ACTION:
    moveG_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {
            "use_sim_time": True}, {"ROB_PARAM": 'egp64'}],
    )
    # MoveXYZW ACTION:
